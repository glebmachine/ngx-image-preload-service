module.exports = function (config) {
  ...
  config.set({
    ...
    files: [
      ...
      // Own libriaries
      { pattern: 'node_modules/@betadigitalproduction/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/@betadigitalproduction/**/*.js.map', included: false, watched: false },
